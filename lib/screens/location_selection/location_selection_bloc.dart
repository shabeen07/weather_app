...
class LocationSelectionBloc
  ...
  Future<void> _onFetchWeather(
      FetchWeatherEvent event, Emitter<LocationSelectionState> emit) async {
    /// set loading state
    ...
    try {
      WeatherModel weatherModel =
          await _weatherService.getWeather(event.locationName);
      ...
      return emit(e is WeatherResultError
          ? LocationSelectionState.error(e.message)
          : const LocationSelectionState.error('Something went wrong!'));
    }
  }
}
